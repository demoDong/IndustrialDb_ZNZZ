...
export class BigdatabasenewV2Component implements OnInit {
  ...
  constructor(
    ...
    private BigdatabaseChartService: BigdatabasenewChartService,
    private BigdatabaseTableService: BigdatabasenewTableService,
    private BigdatabaseDbsrcService: BigdatabasenewDbsrcService,
